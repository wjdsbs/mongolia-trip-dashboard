    ...
    <main>
      <header>
        <div className="eyebrow">
          <span className="trip-mark">M</span> OUR LITTLE MONGOLIAN TRIP{" "}
        ...
        <div className="title-row">
          <div>
            ...
            <h1>
              몽골, 우리의 3일<span className="title-dot">.</span>
            </h1>
          </div>
          <span className="status">
            {now ? tripStatus(today) : "몽골 여행"}
          </span>
        </div>
      ...
      <nav className="date-tabs" role="tablist" aria-label="여행 날짜">
        {TRIP_DAYS.map((d, i) => (
          <button
            key={d.date}
            id={`tab-${d.date}`}
            ...
            onKeyDown={(e) => {
              if (["ArrowLeft", "ArrowRight", "Home", "End"].includes(e.key)) {
                ...
                document.getElementById(`tab-${TRIP_DAYS[next].date}`)?.focus();
              }
            }}
          >
            <span>
                ...
                <div className="night-summary">
                  ...
                  <div className="night-values">
                    ...
                    <span>
                      ...
                      월몰 {n.moonset ? localTime(new Date(n.moonset)) : "없음"}
                    </span>
                  </div>
                </div>
              )}
      ...
      <footer>
        <span className="footer-brand">몽골, 우리의 3일.</span>
        <p>
          날씨 데이터{" "}
